...
namespace rainbow.Models
{
    ...
    public partial class DBContainer : DbContext
    {
        ...
        public virtual ObjectResult<P_Sys_GetRightOperate_Result1> P_Sys_GetRightOperate(string userId, string url)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<P_Sys_GetRightOperate_Result1>("P_Sys_GetRightOperate", userIdParameter, urlParameter);
        }
